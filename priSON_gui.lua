...
SectionsContainer.Size = UDim2.new(1, -160, 1, -20)
SectionsContainer.Position = UDim2.new(0, 160, 0, 10)
...
local function CreateDropdown(parent, text, options)
    ...
    btnLayout.Size = UDim2.new(1, -30, 0, 25)
    btnLayout.Position = UDim2.new(0, 15, 0, 30)
...
CreateToggle(MiscTab, "Fake headless")
...
LoadScreen.Size = UDim2.new(0, 160, 0, 160)
LoadScreen.Position = UDim2.new(0.5, -80, 0.5, -80)
