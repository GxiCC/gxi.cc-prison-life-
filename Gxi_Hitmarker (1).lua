...
Toggle(Content, "Gray Sky", false, function(v)
    ...
    if v then
        ...
        -- серое небо (приближение к Bloxstrap FFlagDebugSkyGray)
        ...
        Lighting.ColorShift_Bottom = Color3.fromRGB(130, 130, 130)
        ...
        -- пустой Sky без звёзд/солнца, чтобы небо было ровным серым
