...
--------------------------------------------------
-- RAGE MODULE (FIXED TEAM & WALL CHECK TOGGLES)
--------------------------------------------------
...
local function GetClosestPlayerInFOV(preferredPart)
    ...
    for _, player in ipairs(Players:GetPlayers()) do
        -- Гарантированный пропуск самого себя
...
local function applyKorblox(char)
    ...
    local targetPart = char:FindFirstChild("RightUpperLeg") or char:FindFirstChild("Right Leg")
    ...
    local mesh = Instance.new("SpecialMesh", fakePart)
